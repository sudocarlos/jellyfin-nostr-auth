...
- `LoginPageTests` — the pre-login page and vendored nostr bundle are served
  anonymously from embedded resources, and the page computes the NIP-98 payload
  hash itself (no `nip98.hashPayload`).
